 ...
 */
export function generateZadarmaSignature(method, params = {}) {
  try {
    // Sort params by key
 ...
 */
export function createZadarmaHeaders(method, params = {}) {
 ...
 */
export async function zadarmaRequest(endpoint, params = {}, httpMethod = 'GET') {
